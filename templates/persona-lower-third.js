...
lib.ssMetadata = [
		{name:"persona_lower_third_atlas_1", frames: [[1082,0,885,886],[0,0,1080,1080]]},
		{name:"persona_lower_third_atlas_2", frames: [[0,0,1080,1080]]},
		{name:"persona_lower_third_atlas_3", frames: [[0,0,1080,1080]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.0991,0.0991);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.portrait).wait(1).to({_off:false},0).to({scaleX:1,y:77},8).wait(10).to({regX:0,regY:0,x:31,y:23},0).wait(1));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/persona_lower_third_atlas_1.png?1666890305226", id:"persona_lower_third_atlas_1"},
		{src:"images/persona_lower_third_atlas_2.png?1666890305226", id:"persona_lower_third_atlas_2"},
		{src:"images/persona_lower_third_atlas_3.png?1666890305226", id:"persona_lower_third_atlas_3"}
	],
	preloads: []
};
